...
const Header = () => {
  return (
    <div>
      <div className="main flex justify-between p-5 bg-gray-100">
        <div className="left-side flex justify-center items-center gap-1">
          <h2 className="text-xl font-sans font-semibold text-red-600">
            Talk <span className="text-3xl text-blue-600">Sense</span>
          </h2>
          <svg
        ...
        <div className="right-side flex justify-center items-center gap-12">
          <button
            onClick={() => toast("Will work on future")}
            className="price text-xl font-semibold text-gray-600"
          >
            Pricing
          </button>
          <button
            onClick={() => toast("Will work on future")}
            className="about text-xl font-semibold text-gray-600"
          >
            About us
          </button>
        </div>
